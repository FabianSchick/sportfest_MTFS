...
<body>
	<div class="container">
		...
		<nav class="navbar navbar-inverse"> <jsp:include page="menu.jsp"
			flush="true" /> </nav>
				...
				<table class="table">
					...
					<tbody>
						...
						<tr class="success">
							...
							<td><%=myRes.getString(8)%> <%=einheiten[i] %></td>
						</tr>
						<%
							myRes.next();
										}
