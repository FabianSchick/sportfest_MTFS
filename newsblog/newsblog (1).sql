...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 12. Mai 2016 um 08:59
...
--
-- Tabellenstruktur für Tabelle `ergebnissesportfest`
--
...
--
-- Daten für Tabelle `ergebnissesportfest`
--

INSERT INTO `ergebnissesportfest` (`EintragsID`, `schuelerID`, `sportfestID`, `Sportart`, `Ergebnis`, `Punkte`) VALUES
(5, 20, 1, 'Sprinten', '10.0', 200),
(6, 1, 1, 'Sprinten', '10.7', 131),
(7, 1, 1, 'Dauerlauf', '20.33', 4179),
(8, 1, 1, 'Weitwurf', '29.1', -2770),
(9, 1, 1, 'Weitsprung', '3.8', -2796),
(10, 1, 1, 'Sprinten', '10.0', 200),
(11, 1, 1, 'Dauerlauf', '20.33', 4179),
(12, 1, 1, 'Weitwurf', '30.5', -2769),
(13, 1, 1, 'Weitsprung', '3.8', -2796),
(14, 1, 1, 'Sprinten', '10.0', 200),
(15, 1, 1, 'Dauerlauf', '23.5', 4176),
(16, 1, 1, 'Weitwurf', '33.6', -2766),
(17, 1, 1, 'Weitsprung', '3.5', -2796),
(18, 3, 1, 'Sprinten', '10.0', 200),
(19, 3, 1, 'Dauerlauf', '19.0', 4181),
(20, 3, 1, 'Weitwurf', '30.0', -2770),
(21, 3, 1, 'Weitsprung', '3.7', -2796),
(22, 3, 1, 'Sprinten', '10.0', 200),
(23, 3, 1, 'Dauerlauf', '20.0', 4180),
(24, 3, 1, 'Weitwurf', '10.0', -2790),
(25, 3, 1, 'Weitsprung', '20.0', -2780),
(26, 2, 1, 'Sprinten', '10.0', 200),
(27, 2, 1, 'Dauerlauf', '10.0', 4190),
(28, 2, 1, 'Weitwurf', '10.0', -2790),
(29, 2, 1, 'Weitsprung', '10.0', -2790),
(30, 5, 1, 'Sprinten', '10.0', 200),
(31, 5, 1, 'Dauerlauf', '10.0', 4190),
(32, 5, 1, 'Weitwurf', '10.0', -2790),
(33, 5, 1, 'Weitsprung', '10.0', -2790),
(34, 9, 1, 'Sprinten', '10.0', 200),
(35, 9, 1, 'Dauerlauf', '10.0', 4190),
(36, 9, 1, 'Weitwurf', '120.0', -2680),
(37, 9, 1, 'Weitsprung', '10.0', -2790),
(38, 14, 1, 'Sprinten', '10.0', 200),
(39, 14, 1, 'Dauerlauf', '210.0', 3990),
(40, 14, 1, 'Weitwurf', '20.0', -2780),
(41, 14, 1, 'Weitsprung', '10.0', -2790),
(42, 15, 1, 'Sprinten', '10.0', 200),
(43, 15, 1, 'Dauerlauf', '120.0', 4080),
(44, 15, 1, 'Weitwurf', '10.0', -2790),
(45, 15, 1, 'Weitsprung', '10.0', -2790),
(46, 16, 1, 'Sprinten', '10.0', 200),
(47, 16, 1, 'Dauerlauf', '10.0', 4190),
(48, 16, 1, 'Weitwurf', '10.0', -2790),
(49, 16, 1, 'Weitsprung', '10.0', -2790);
...
--
-- Tabellenstruktur für Tabelle `schuelersportfest`
--
...
--
-- Daten für Tabelle `schuelersportfest`
--
...
--
-- Tabellenstruktur für Tabelle `sportfeste`
--
...
(2, 'Fabian', 'Schick', 'info@fabian-schick.de', '7c222fb2927d828af22f592134e8932480637c0d', 1, 'j5hh91b2osc8ovgte0i4pfh2p5'),
...
--
-- Indizes für die Tabelle `ergebnissesportfest`
--
...
--
-- Indizes für die Tabelle `schuelersportfest`
--
ALTER TABLE `schuelersportfest`
  ADD PRIMARY KEY (`SchuelerID`);

--
-- Indizes für die Tabelle `sportfeste`
--
...
--
-- AUTO_INCREMENT für Tabelle `ergebnissesportfest`
--
ALTER TABLE `ergebnissesportfest`
  MODIFY `EintragsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
--
...
--
-- AUTO_INCREMENT für Tabelle `schuelersportfest`
--
ALTER TABLE `schuelersportfest`
  MODIFY `SchuelerID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=513;
--
-- AUTO_INCREMENT für Tabelle `sportfeste`
--
ALTER TABLE `sportfeste`
...
--
-- Constraints der Tabelle `ergebnissesportfest`
--
ALTER TABLE `ergebnissesportfest`
